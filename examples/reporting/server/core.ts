...
import { CsvSearchSourceExportType } from './export_types/csv_searchsource_scroll';
import { CsvV2ExportType } from './export_types/csv_v2';
import { CsvSearchSourceScrollApiExportType } from './export_types/csv_searchsource_scroll';
  ...
  public registerFeature() {
    ...
    if (deprecatedRoles !== false) {
      ...
      features.registerElasticsearchFeature({
        id: 'reporting2',
        catalogue: ['reporting2'],
        management: {
          insightsAndAlerting: ['reporting2'],
        },
        privileges,
      });
    } else {
