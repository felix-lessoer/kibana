...
const prefixInternalMainPath = '/internal/reporting2';
export const INTERNAL_ROUTES = {
  ...
  GENERATE_PREFIX: prefixInternalMainPath + '/generate', // exportTypeId is added to the final path
};

const prefixPublicPath = '/api/reporting2';
